...
/***************************************************************************
 PolygonSquarer
                                 A QGIS plugin
 Least square aglorithm
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
                              -------------------
        begin                : 2018-06-29
        git sha              : $Format:%H$
        copyright            : (C) 2018 by imran
        email                : imran.lolkat@ign.fr
 ***************************************************************************/
 ...
 ***************************************************************************/
"""
from PyQt5.QtCore import QSettings, QTranslator, qVersion, QCoreApplication, QProcess
...
class PolygonSquarer:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&PolygonSquarer')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/polygon_squarer/icon.png'
        self.add_action(
        icon_path,
        text=self.tr(u'PolygonSquarerLS'),
        callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            QgsProject.instance().addMapLayers([resLayer,], True)
            process.kill()
